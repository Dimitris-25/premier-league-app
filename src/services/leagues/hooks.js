// src/services/leagues/hooks.js
// Hooks for Leagues service
...
// Read-only fields (adjust if PK differs)
const READ_ONLY = ["league_id", "api_league_id", "created_at", "updated_at"];

// Required on create
const REQUIRED_ON_CREATE = ["api_league_id", "name"];
